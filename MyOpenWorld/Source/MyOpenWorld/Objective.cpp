...
void UInteractionObjective::ActivateObjective(AActor* Character)
{
	...
	if (auto * InteractableTarget = Cast<IInteractableObject_Interface>(Target))
	{
...
void ULocationObjective::ActivateObjective(AActor* Character)
{
    ...
    {
    LocMarker->OnLocationReached.AddLambda([this, Character]( AActor* LocationMarker, AActor* OverlappedActor)
    {
